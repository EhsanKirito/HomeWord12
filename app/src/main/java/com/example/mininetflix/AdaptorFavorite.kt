...
class AdaptorFavorite(private val name:ArrayList<String>, private val photo:ArrayList<Int>, private val favor:ArrayList<Int>): RecyclerView.Adapter<AdaptorFavorite.ViewHolder>() {
